...
import kotlinx.android.synthetic.main.kt_activity_net_request.*
import kotlinx.coroutines.*
import okhttp3.OkHttpClient
import okhttp3.Request

class TestNetRequestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kt_activity_net_request)
